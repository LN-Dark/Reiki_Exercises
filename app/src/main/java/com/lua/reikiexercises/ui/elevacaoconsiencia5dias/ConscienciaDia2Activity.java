...
public class ConscienciaDia2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextInputEditText txt_observacao = findViewById(R.id.edittext_consciencia_dia2_observacao_input);
        MaterialButton btn_save = findViewById(R.id.btn_fechar_consciencia_dia2);
        SharedPreferences prefs = getSharedPreferences("ReikiExercises", MODE_PRIVATE);
        String pergunta1 = prefs.getString("ReikiExercises_consciencia_Dia2_observacao", "");
        if(!pergunta1.equals("")){
        ...
        btn_save.setOnClickListener(v -> {
            ...
            if(!txt_observacao.getText().toString().equals("")){
                editor.putString("ReikiExercises_consciencia_Dia2_observacao", txt_observacao.getText().toString());
            }else{
                editor.putString("ReikiExercises_consciencia_Dia2_observacao", "");
            }
            editor.apply();
            finish();
        });
